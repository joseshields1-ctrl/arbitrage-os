...
const scenarios: ValidationScenario[] = [
  ...
  {
    name: "D) Completed Vehicle - Negative Drift Stress Case",
    context: {
      description:
        "Completed retail SUV with underestimated transport and weak realized exit pricing.",
      mileage: 101800,
    },
    deal: {
      id: "validation-completed-negative-drift",
      ...
      discovered_date: daysAgoIso(32),
      purchase_date: daysAgoIso(25),
      listing_date: daysAgoIso(10),
      sale_date: daysAgoIso(1),
      completion_date: daysAgoIso(1),
      unit_count: null,
      unit_breakdown: null,
      prep_metrics: null,
    },
    financials: {
      deal_id: "validation-completed-negative-drift",
      acquisition_cost: 15000,
      buyer_premium_pct: 0,
      buyer_premium_overridden: false,
      tax_rate: null,
      tax: null,
      transport_cost_actual: 4000,
      transport_cost_estimated: 500,
      repair_cost: 2800,
      prep_cost: 1900,
      estimated_market_value: 24000,
      sale_price_actual: 15000,
      projected_profit: 0,
      realized_profit: null,
    },
    metadata: {
    ...
    return {
      ...
      output: {
        ...
        validation_summary: {
          ...
          postmortem: enriched.engine.postmortem,
          profit_drift_flag: enriched.engine.postmortem.profit_drift_flag,
          cost_overrun_flag: enriched.engine.postmortem.cost_overrun_flag,
          drift_sources: enriched.engine.postmortem.drift_sources,
          postmortem_incomplete: enriched.engine.postmortem.postmortem_incomplete,
